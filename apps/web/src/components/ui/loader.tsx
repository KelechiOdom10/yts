...
const Bars = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    fill="currentColor"
    role="img"
    aria-labelledby="barsLoadingTitle"
    {...props}
  >
    <title id="barsLoadingTitle">Loading animation</title>
...
const Spin = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    role="img"
    aria-labelledby="spinLoadingTitle"
    {...props}
  >
    <title id="spinLoadingTitle">Loading animation</title>
